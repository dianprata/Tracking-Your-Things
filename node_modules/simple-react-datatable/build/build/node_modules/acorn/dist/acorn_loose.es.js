...
lp$1.parseClass = function (isStatement) {
  ...
  while (!this.closes(_acorn.tokTypes.braceR, indent, line)) {
    ...
    if (isDummy(method.key)) {
      if (isDummy(this$1.parseMaybeAssign())) this$1.next();this$1.eat(_acorn.tokTypes.comma);continue;
    }
...
_acorn2.default.defaultOptions.tabSize = 4;
...
_acorn2.default.parse_dammit = parse_dammit;
_acorn2.default.LooseParser = LooseParser;
_acorn2.default.pluginsLoose = pluginsLoose;
