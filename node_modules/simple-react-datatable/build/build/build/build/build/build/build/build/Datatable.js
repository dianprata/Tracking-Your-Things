  ...
  (0, _createClass3.default)(Datatable, [{
    ...
    value: function render() {
      ...
      var cols = this.props.cols.map(function (c) {
        return _react2.default.createElement('th', { key: c.name }, c.name);
      });

      var data = this.props.data.map(function (dt) {

        var row_data = _this3.props.cols.map(function (rd) {
          return _react2.default.createElement('td', { key: Date.now() + Math.random() }, dt[rd.key]);
        });

        return _react2.default.createElement('tr', { key: dt.id }, row_data);
      });

      return _react2.default.createElement('table', { ref: 'dt' }, _react2.default.createElement('thead', null, _react2.default.createElement('tr', null, cols)), _react2.default.createElement('tbody', null, data));
    }
  }]);
  return Datatable;
}(_react.Component);
