...
if (detect.symbols() && _typeof(Symbol()) === 'symbol') {
...
if (detect.promises()) {
  runner.test('.isPromise', function () {
    ...
    a.strictEqual(type.isPromise(), false);
    a.strictEqual(type.isPromise({ then: function then() {} }), true);
  });
}
...
if (detect.collections()) {
  runner.test('.isIterable', function () {
    ...
    a.strictEqual(type.isIterable({ then: function then() {} }), false);
  });
}